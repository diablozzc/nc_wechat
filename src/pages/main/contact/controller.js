...
class ContactController {
  ...
  $onInit() {
    this.member_list = [
      ...
      {title:'胡剑林',desc:'社区综合',headImg:'http://img.mrshare.cn/female.png',tel:'58399902',duty:'宣传文教、青保、组织居民开展自治活动、业委会建设'},
      ...
      {title:'丁志凤',desc:'专职党务,计生妇代',headImg:'http://img.mrshare.cn/female.png',tel:'58399902'},
